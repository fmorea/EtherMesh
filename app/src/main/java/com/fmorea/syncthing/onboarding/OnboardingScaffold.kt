...
import com.fmorea.syncthing.util.isTelevision
...
private fun isCompactOnboardingScreen(): Boolean {
    ...
    val compactScreenMaxSize = COMPACT_SCREEN_MAX_DP
    return configuration.screenWidthDp <= compactScreenMaxSize ||
            configuration.screenHeightDp <= compactScreenMaxSize
}
